...
//   return (
//     <div className={`fixed top-6 right-[-29px] -translate-x-1/2 p-4 rounded-xl shadow-lg text-white font-semibold transition-transform duration-300 ease-out z-50 transform scale-100 ${bgColor} flex items-center gap-3`}>
//       {icon}
//       <span>{message}</span>
